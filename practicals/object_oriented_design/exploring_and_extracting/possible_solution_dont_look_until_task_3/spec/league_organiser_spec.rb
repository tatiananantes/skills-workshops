...
describe 'LeagueOrganiser' do
  ...
  describe 'works when the user uses the programme correctly - happy path/scenario' do
...
matches
  ...
  describe 'correctly errors when the user is not using the programme correctly - unhappy path/scenario' do
